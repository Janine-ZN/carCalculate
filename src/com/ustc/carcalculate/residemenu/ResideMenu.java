...
public class ResideMenu extends FrameLayout {
	...
	private void initViews(Context context) {
		...
		imageViewShadow = (ImageView) findViewById(R.id.iv_shadow);// 主界面下的阴影效果
		layoutLeftMenu = (LinearLayout) findViewById(R.id.layout_left_menu);// 左边的菜单
		layoutRightMenu = (LinearLayout) findViewById(R.id.layout_right_menu);// 右边的菜单
		imageViewBackground = (ImageView) findViewById(R.id.iv_background);// 背景
	...
	public void setShadowVisible(boolean isVisible) {
		if (isVisible)
			imageViewShadow.setImageResource(R.drawable.shadow);// 在ImageView控件上加载图片shadow.png
		else
		...
		public void onAnimationStart(Animator animation) {
			if (isOpened()) {
				...
				if (menuListener != null)
					menuListener.openMenu();// /openMenu
			}
		}
	...
	/**
	 * a helper method to build scale down animation; 动画效果
	 * 
	 * @param target
	 * @param targetScaleX
	 * @param targetScaleY
